...
1. **整理优先** - 整理已有知识，不胡乱创造细节
2. **简洁至上** - 默认采用最简洁的格式，用户要求再扩展
3. **用户确认** - 创建目标/项目前先询问期望的详细程度
4. **渐进演进** - 从简单开始，根据使用反馈逐步完善
...
- `LEARNINGS.md` - 纠正和知识 gap
- `ERRORS.md` - 命令/操作失败
- `FEATURE_REQUESTS.md` - 用户请求的功能

**最近学习**: [LRN-20260405-001] - LLM Wiki 原则是整理不是创造
